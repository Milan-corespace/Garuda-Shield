...
- Subscription & Pattern Detection
  Identifies recurring transaction patterns to highlight hidden or forgotten charges.
- Explainable Transaction Flags (Glass-Box AI)
  Converts security and risk decisions into simple, human-readable explanations.
- Scam Text Analysis (NLP-based)
  Detects common fraud patterns in SMS/email content using rule and pattern analysis.
- 5D Financial Health Profile
  Visual representation of user financial behavior across spending, savings, and credit dimensions.
...
- Assisted in NLP-based scam detection logic
...
View your app in AI Studio: https://ai.studio/apps/drive/12hmFqoRfAgQYaoFILYwfq-5KzorAq2N7
